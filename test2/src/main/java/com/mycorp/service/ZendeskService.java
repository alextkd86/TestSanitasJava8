...
public class ZendeskService {
    ...
    @Value("${envPC['zendesk.ticket'] ?: 'Peticion por defecto'}")
    public String PETICION_ZENDESK= "";

    @Value("${envPC['zendesk.token'] ?: 'Token por defecto'}")
    public String TOKEN_ZENDESK= "";

    @Value("${envPC['zendesk.url'] ?: 'URL por defecto'}")
    public String URL_ZENDESK= "";

    @Value("${envPC['zendesk.user'] ?: 'User por defecto'}")
    public String ZENDESK_USER= "";

    @Value("${envPC['tarjetas.getDatos'] ?: 'getDatosTarjetas por defecto'}")
    public String TARJETAS_GETDATOS = "";

    @Value("${envPC['cliente.getDatos'] ?: 'getDatosClientes por defecto'}")
    public String CLIENTE_GETDATOS = "";

    @Value("${envPC['zendesk.error.mail.funcionalidad'] ?: 'errorMail por defecto'}")
    public String ZENDESK_ERROR_MAIL_FUNCIONALIDAD = "";

    @Value("${envPC['zendesk.error.destinatario'] ?: 'errorDestinatario por defecto'}")
...
//    @Autowired
//    @Qualifier(value="portalClientesWebEJBRemote")
...
//		emailService = MensajeriaService.class.newInstance();
    ...
    /**
     * Obtenemos el idCliente de la tarjeta
     * @param usuarioAlta
     * @param mapper
     * @param clientName
     * @param idCliente
     * @param datosServicio
     */
    private void obtenerIdCliente(UsuarioAlta usuarioAlta, ObjectMapper mapper, StringBuilder clientName, String idCliente, StringBuilder datosServicio) {
    ...
    /**
     * Anyadimos datos al formulario
     * @param usuarioAlta
     * @param datosUsuario
     * @param datosBravo
     * @param userAgent
     */
    private void anyadeDatosAlFormulario(UsuarioAlta usuarioAlta, StringBuilder datosUsuario, StringBuilder datosBravo, String userAgent) {
    ...
    /**
     * Vamos concatenando a datosBravo
     * @param datosBravo
     * @param cliente
     * @throws ParseException
     */
    public void anyadimosADatosBravo(StringBuilder datosBravo, DatosCliente cliente) throws ParseException {
